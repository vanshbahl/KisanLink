...
SEED_STATE = {
    ...
    "logisticsPickups": [
        {"id": "PK-2048", "farmer": "Vansh", "farm": "Green Field Farm", "farmLocation": "Murthal, Sonipat, Haryana", "crop": "Baby Spinach", "cropHi": "बेबी पालक", "quantityKg": 8, "pickupWindow": "Tomorrow · 7–10 AM", "orderRefs": ["KL-ORD-1037"], "vehicleId": "VEH-01", "driver": "Suresh Kumar", "status": "assigned", "notes": "Use ventilated crates.", "routeId": "RTE-101", "checklist": {"arrived": False, "quantityVerified": False, "qualityChecked": False, "loadSecured": False, "pickupCompleted": False}, "timeline": [{"label": "Pickup created", "labelHi": "पिकअप बनाया गया", "at": datetime.now().isoformat()}]},
        {"id": "PK-2051", "farmer": "Vansh", "farm": "Green Field Farm", "farmLocation": "Murthal, Sonipat, Haryana", "crop": "Fresh Tomatoes", "cropHi": "ताज़े टमाटर", "quantityKg": 300, "pickupWindow": "Today · 2–4 PM", "orderRefs": ["KL-ORD-1042"], "status": "unassigned", "notes": "Grade A+ crates.", "routeId": "RTE-POOL-01", "checklist": {"arrived": False, "quantityVerified": False, "qualityChecked": False, "loadSecured": False, "pickupCompleted": False}, "timeline": [{"label": "Pickup created", "labelHi": "पिकअप बनाया गया", "at": datetime.now().isoformat()}]},
