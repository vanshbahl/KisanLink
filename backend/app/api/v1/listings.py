...
async def parse_voice_listing(
    ...
    """
    Server-side Gemini extraction with a deterministic outage/key fallback. This
    endpoint creates a reviewable draft only; the normal listing flow publishes it.
    """
