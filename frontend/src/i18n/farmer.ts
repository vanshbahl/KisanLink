...
const copy = {
  en: {
    ...
    // --- Behtar Sauda while listing (optional, beside the sell form) --------
    saudaTitle: 'Behtar Sauda', saudaPoweredBy: 'Powered by KisanLink Market Maker',
    saudaWaiting: 'Tell us your crop and quantity. We will look for a better deal for you.',
    saudaLooking: 'Looking for a better deal for {crop}…',
    saudaNone: 'No better deal for {crop} right now.', saudaNoneHint: 'Sell normally. We will tell you if one opens.',
    saudaForming: 'A deal for {crop} is forming', saudaFormingHint: 'Buyers are joining. We will tell you when it is ready.',
    saudaReady: 'Better deal for {crop} is ready', saudaFor: '{qty} kg {crop}',
    saudaWhyTruck: 'A truck is filling up near you', saudaWhyBuyers: '{count} buyers want it',
    saudaWhyPooled: '{qty} kg from farmers nearby is already in',
    saudaNormalPrice: 'Normal price', saudaDealPrice: 'Behtar Sauda',
    saudaGain: '+₹{amount}/kg', saudaExtra: 'About {amount} more on your {qty} kg',
    saudaView: 'See the deal', saudaJoin: 'Join this deal', saudaSellNormally: 'Sell normally instead',
    saudaJoined: 'You are in this deal', saudaJoinedHint: 'Your price is set to {price}/kg. Finish listing as usual.',
    saudaJoinedToast: 'Joined. Price set to {price}/kg.', saudaLeftToast: 'Back to a normal listing.',
  ...
  hi: {
    ...
    // --- Behtar Sauda while listing --------------------------------------
    saudaTitle: 'बेहतर सौदा', saudaPoweredBy: 'KisanLink Market Maker से',
    saudaWaiting: 'अपनी फसल और मात्रा बताएं। हम आपके लिए बेहतर सौदा ढूंढेंगे।',
    saudaLooking: '{crop} के लिए बेहतर सौदा ढूंढ रहे हैं…',
    saudaNone: '{crop} के लिए अभी कोई बेहतर सौदा नहीं है।', saudaNoneHint: 'सामान्य तरीके से बेचें। खुलते ही हम बताएंगे।',
    saudaForming: '{crop} का सौदा बन रहा है', saudaFormingHint: 'खरीदार जुड़ रहे हैं। तैयार होते ही बताएंगे।',
    saudaReady: '{crop} का बेहतर सौदा तैयार है', saudaFor: '{qty} किलो {crop}',
    saudaWhyTruck: 'आपके पास एक ट्रक भर रहा है', saudaWhyBuyers: '{count} खरीदार चाहते हैं',
    saudaWhyPooled: 'पास के किसानों की {qty} किलो पहले से है',
    ...
    saudaView: 'सौदा देखें', saudaJoin: 'इस सौदे में जुड़ें', saudaSellNormally: 'सामान्य तरीके से बेचें',
    saudaJoined: 'आप इस सौदे में हैं', saudaJoinedHint: 'आपका दाम {price}/किलो तय हुआ। बाकी वैसे ही पूरा करें।',
    saudaJoinedToast: 'जुड़ गए। दाम {price}/किलो तय हुआ।', saudaLeftToast: 'वापस सामान्य लिस्टिंग पर।',
