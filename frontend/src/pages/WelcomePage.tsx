...
export function WelcomePage() {
  ...
  return (
    <main className="welcome-page">
      <header className="welcome-header"><Logo /><div className="public-header-actions"><LanguageSwitcher compact /><Link to="/start" className="btn btn-ghost">{t('continue')}</Link></div></header>
      <section className="welcome-hero">
        <div className="welcome-copy">
          ...
          <p>{t('heroCopy')}</p>
          <div className="welcome-actions"><Link to="/start" className="btn btn-primary btn-large">{t('getStarted')} <ArrowRight size={19} /></Link><a href="#demo" className="btn btn-secondary btn-large">{t('exploreDemo')}</a></div>
