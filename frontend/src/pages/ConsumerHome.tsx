...
export function ConsumerHome() {
  ...
  return (
    <div className="page consumer-page">
      <section className="consumer-intro"><div><span className="eyebrow"><MapPin size={15} /> Dwarka, New Delhi</span><h1>Fresh from farms<br />near you.</h1><p>Seasonal produce, picked with care and priced transparently.</p></div><div className="consumer-hero-art"><span>Farm fresh today</span><div className="hero-basket" aria-hidden="true"><img src="/assets/produce/tomato.webp" alt="" /><img src="/assets/produce/spinach.webp" alt="" /><img src="/assets/produce/carrot.webp" alt="" /><img src="/assets/produce/apple.webp" alt="" /></div><small><ShieldCheck size={15} /> Quality checked farms</small></div></section>
      ...
      <section className="section-block">
        ...
        {loading ? <DashboardSkeleton /> : error ? <div className="error-inline">Couldn’t load fresh produce.</div> : filtered.length ? <div className="product-grid">{filtered.map((listing) => <ProductCard key={listing.id} listing={listing} />)}</div> : <div className="no-results"><Sprout size={38} /><h3>No produce found</h3><p>Try another search or category.</p></div>}
      </section>
