...
import { seedBoardPrices } from '../services/pricingEngine'

/**
 * Arshdeep's six NCR corridor seeds, kept separate so main's canonical seed remains readable.
 *
 * No price is typed here. Each board and crop segment names its benchmark commodity and takes
 * its floor / mandi / ceiling / current values from the centralized pricing engine; at read
 * time `prototypeService` re-derives them from the live AGMARKNET benchmark.
 */
  ...
  return [
    {
      ...
      crops: [
        ...
        },
        {
          ...
          visual: 'potato',
          benchmarkCrop: 'Potato',
          ...seedBoardPrices('Potato'),
          platformFeePct: 0.02,
          storageType: 'ambient',
          lots: [
    ...
    },
    {
      ...
      crops: [
        ...
        },
        {
          ...
          visual: 'leafy',
          benchmarkCrop: 'Spinach',
          ...seedBoardPrices('Spinach'),
          platformFeePct: 0.02,
          storageType: 'ambient',
          lots: [
    ...
    },
    {
      ...
      imageSrc: '/assets/produce/potato.webp',
      visual: 'root',
      benchmarkCrop: 'Carrot',
      ...seedBoardPrices('Carrot'),
      platformFeePct: 0.02,
      routeDistanceKm: 68,
      vehicleId: 'VEH-02',
